      ...
      <header className="bg-primary text-white py-16">
        <div className="container mx-auto px-4">
          ...
          <p className="text-xl text-white/90 max-w-2xl">
            Reliable delivery and setup services for your events
          </p>
        </div>
      </header>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <p className="text-gray-600 mb-6">
                We handle all aspects of equipment delivery, setup, and removal
              ...
              <ul className="space-y-3 mb-8">
                <li className="flex items-start">
                  ...
                  <span>Timely delivery to your venue</span>
                </li>
                <li className="flex items-start">
                  <span className="bg-primary text-white rounded-full w-6 h-6 flex items-center justify-center text-sm mr-3 mt-0.5">
                    ✓
                ...
                <li className="flex items-start">
                  ...
                  <span>Equipment arrangement and positioning</span>
                </li>
                <li className="flex items-start">
                  <span className="bg-primary text-white rounded-full w-6 h-6 flex items-center justify-center text-sm mr-3 mt-0.5">
                    ✓
                  </span>
                  <span>Post-event dismantling</span>
                </li>
                <li className="flex items-start">
                  <span className="bg-primary text-white rounded-full w-6 h-6 flex items-center justify-center text-sm mr-3 mt-0.5">
                    ✓
                  </span>
                  <span>Equipment pickup and removal</span>
                </li>
                <li className="flex items-start">
                  <span className="bg-primary text-white rounded-full w-6 h-6 flex items-center justify-center text-sm mr-3 mt-0.5">
                    ✓
